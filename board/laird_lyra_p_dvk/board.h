...
// Board definition for Laird Connectivity's Lyra P (PCB) DVK with part number 453-00090-K1.
// See https://www.lairdconnect.com/documentation/user-guide-lyra-p-development-kit.
#ifndef BOARD_LAIRD_LYRA_P_DVK_BOARD_H_
#define BOARD_LAIRD_LYRA_P_DVK_BOARD_H_

// Waps usart defines
#define BOARD_USART_ID                  0

// Use if Lyra P DVK Switch (SW1) Position is C-DEV (Default).
#define BOARD_USART_GPIO_PORT           GPIO_PORTA
#define BOARD_USART_TX_PIN              0
#define BOARD_USART_RX_PIN              7

// Use if Lyra P DVK Switch (SW1) Position is AT / BGx.
// #define BOARD_USART_GPIO_PORT           GPIO_PORTA
// #define BOARD_USART_TX_PIN              0
...
#define BOARD_BUTTON_PIN_LIST           {{8 GPIO_PORTC, 7}}
...
#endif /* BOARD_LAIRD_LYRA_P_DVK_BOARD_H_ */
