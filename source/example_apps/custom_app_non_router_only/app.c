...
#define DEBUG_LOG_MODULE_NAME "CUSTOM_APP_NON_ROUTER_ONLY"
...
void App_init(const app_global_functions_t * functions)
{
    ...
    if (lib_settings->getNodeAddress(&node_address) == APP_RES_INVALID_CONFIGURATION)
    {
        /* Force node role (non-router, Low-Energy, autorole OFF) as this is the 1st boot. */
        lib_settings->setNodeRole(app_lib_settings_create_role(APP_LIB_SETTINGS_ROLE_SUBNODE,0x0)); 
    }
